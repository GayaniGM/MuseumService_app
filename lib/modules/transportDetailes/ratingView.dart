...
import 'package:museumservice_app/models/vehicleListData.dart';
...
class RatingView extends StatelessWidget {
  ...
  const RatingView({Key key, this.vehicleData}) : super(key: key);
            ...
            Row(
              children: <Widget>[
                SizedBox(
                  width: 60,
                  child: Text(
                    (vehicleData.rating * 2).toStringAsFixed(1),
