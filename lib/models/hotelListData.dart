...
class HotelListData {
  ...
  static List<HotelListData> hotelList = [
    HotelListData(
      ...
      titleTxt: 'Sudu Araliya Hotel',
      subTxt: 'Polonnaruwa city',
      dist: 2.0,
      reviews: 80,
      rating: 4.4,
      perNight: 180,
    ...
    HotelListData(
      ...
      titleTxt: 'Deer Park Hotel',
      subTxt: 'New Town, Polonnaruwa',
      dist: 4.0,
      reviews: 74,
      rating: 4.5,
      perNight: 200,
    ...
    HotelListData(
      ...
      titleTxt: 'Honey  bay Hotel',
      subTxt: 'New town, Central city',
      dist: 3.0,
      reviews: 62,
      rating: 4.0,
      perNight: 60,
    ...
    HotelListData(
      ...
      titleTxt: 'Night peek Hotel',
      subTxt: 'Near old city, Polonnaruwa',
      dist: 2.0,
      reviews: 240,
      rating: 4.5,
      isSelected: false,
  ...
  static List<HotelListData> popularList = [
    ...
    HotelListData(
      ...
      titleTxt: 'Near Elahera',
    ),
    HotelListData(
      imagePath: 'assets/images/popular_4.png',
      titleTxt: 'Thanthirimale',
    ),
    HotelListData(
      imagePath: 'assets/images/popular_5.png',
      titleTxt: 'New town, Polonnaruwa',
    ),
    HotelListData(
      imagePath: 'assets/images/popular_6.png',
      titleTxt: 'Galen bidunu wewa',
    ),
  ];
  ...
  static List<HotelListData> lastsSearchesList = [
    ...
    HotelListData(
      imagePath: 'assets/images/city_3.png',
      titleTxt: 'Honey bay',
      subTxt: '1 Room - 3 Adults',
      dateTxt: '20 - 22 Sep',
    ),
    HotelListData(
      imagePath: 'assets/images/city_4.png',
      titleTxt: 'Elimahana restaurant',
      subTxt: '1 Room - 2 Adults',
      dateTxt: '12 - 22 Nov',
    ),
    HotelListData(
      imagePath: 'assets/images/city_5.png',
      titleTxt: 'Gemi gedara',
      subTxt: '2 Room - 4 Adults',
      dateTxt: '10 - 15 Dec',
    ),
    HotelListData(
      imagePath: 'assets/images/city_6.png',
      titleTxt: 'Deer Park',
