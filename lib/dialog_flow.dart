...
import 'package:museumservice_app/facts_message.dart';
...
class _FlutterFactsChatBotState extends State<FlutterFactsChatBot> {
  ...
  void agentResponse(query) async {
    ...
    AuthGoogle authGoogle = await AuthGoogle(fileJson: "assets/museum-chatbot-296702-72b0a7373265.json").build();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: Text("How can I assist you?", style: TextStyle(color: Colors.green[400]),),
